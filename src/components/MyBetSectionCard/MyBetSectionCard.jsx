...
function MyBetSectionCard({ bData, onClick }) {
  ...
  const displayAmount = (amount) => {
    // Ensure amount is a number and then format it
    ...
    <div className="card" onClick={onClick}>
      ...
      <div className="content">
        ...
        <div className="content-lable-changes">
          ...
          <span className="content-lable-id">{displayAmount(bData.bet_amount)}</span>
        </div>
        <div
          className={
            bData?.plane_status === "cashout"
        ...
        >
          <div className="card-footer-content">
            ...
            >
              {bData?.plane_status === "cashout"
                ? displayAmount(bData.final_amount - bData.bet_amount)
                : displayAmount(bData.bet_amount)}
            </span>
          </div>
          <div>
