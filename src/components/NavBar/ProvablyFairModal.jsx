...
function ProvablyFairModal({ isOpen, onClose }) {
        ...
        <div className="modal-overlay" onClick={onClose}>
            <div className="modal-container">
                <div className="back-section" >
                    <p>{image.backButton}</p>
                    <h4>Back</h4>
                </div>
                <div className="modal-content-provably" onClick={(e) => e.stopPropagation()}>
                    <svg className="svg-line" width="900" height="800" viewBox="0 0 800 600">
